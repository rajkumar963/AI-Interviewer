...
const InterviewCard = ({interviewId, userId, role, type, techstack, level, createdAt}: InterviewCardProps) => {
        ...
        <div className='card-interview'>
            <div>
                ...
                <p className='line-clamp-2 mt-5'>
                    {feedback?.finalAssessment || "You haven't taken the interview yet. Take it now to improve your skills and get valuable feedback!"}
                </p>
            </div>
